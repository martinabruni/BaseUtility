namespace BaseUtility
{
    ...
    {
        public string EntityCannotBeNull { get; set; } = "Entity cannot be null.";
        ...
        public string IdCannotBeNull { get; set; } = "ID cannot be null.";
        ...
        public string PredicateCannotBeNull { get; set; } = "Predicate cannot be null.";
